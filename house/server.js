...
<div style="line-height:1.5">
    ...
    <span style="color:#cfcfcf">
        ...
        `,
                ua: `
<div style="line-height:1.5">
    <b>Зміна варіації інтер'єру</b><br/><br/>

    Ти збираєшся змінити <b>варіацію поточного інтер'єру</b>.<br/>
...
<div style="line-height:1.5">
    ...
    furnitureEditorModal: {
        ...
        sellToOrganization: {
            ru: 'Продажа мебели (на баланс организации)',
            ua: 'Продаж меблів (на баланс організації)',
            en: 'Furniture sale (to the organization balance)',
            de: 'Möbelverkauf (auf das Organisationsguthaben)',
            pl: 'Sprzedaż mebli (na bilans organizacji)',
        },
        moved: {
    ...
    resetFurniture: {
        ...
        refundToOrganization: {
            ru: 'Итого на баланс организации {{orgName}}',
            ua: 'Разом на баланс організації {{orgName}}',
            en: 'Total to the {{orgName}} organization balance',
            de: 'Gesamtbetrag auf das Organisationsguthaben von {{orgName}}',
            pl: 'Łącznie na bilans organizacji {{orgName}}',
        },
        confirm: {
            ru: 'Сбросить мебель',
            ua: 'Скинути меблі',
        ...
        successToOrganization: {
            ru: 'Вся мебель продана и удалена из штаба. ${{amount}} зачислено на баланс организации.',
            ua: 'Усі меблі продані та видалені зі штабу. ${{amount}} зараховано на баланс організації.',
            en: 'All furniture was sold and removed from the HQ. ${{amount}} was credited to the organization balance.',
            de: 'Alle Möbel wurden verkauft und aus dem Hauptquartier entfernt. ${{amount}} wurden dem Organisationsguthaben gutgeschrieben.',
            pl: 'Wszystkie meble zostały sprzedane i usunięte z kwatery. ${{amount}} zostało przelane na bilans organizacji.',
        },
    },
    noFurnitureToReset: {
