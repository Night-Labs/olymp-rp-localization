export default {
    ...
    desc: {
        ...
        pl: 'Nadszedł czas, aby pokazać wszystkim, na co cię stać. Zainwestuj w luksusowy samochód, aby wszyscy wiedzieli: jesteś tutaj, aby zostawić ślad. Po zakupie czas dodać mu mocy i stylu w studio samochodowym. Podnieś stawki i zostań prawdziwym królem dróg!',
        zh:'是时候向大家展示你的能力了。买一辆豪车，这样每个人都知道:你是来这里做成就的。购买之后，是时候在汽车工作室提升它的力量和风格了。提高赌注，成为真正的道路之王!',
    },
};
