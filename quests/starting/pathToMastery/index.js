export default {
    name: {
        ru: 'Путь к мастерству',
        ua: 'Шлях до майстерності',
        en: 'Path to Mastery',
    ...
    desc: {
        ...
        ua: 'Що ж, ти вже достатньо ознайомлений з містом і деякими людьми. Але тобі потрібно більше довіри серед мешканців, щоб отримати серйознішу роботу. Працюй на людей з якими я тебе познайомив і скоро з тобою захочуть мати справу інші люди, більш впливовіші.',
