...
export const stepDto = {
    ...
    goPositions: {
        rentCar: {
            ru: 'Иди к точке аренды транспорта',
        ...
        truckerDeploy: {
            ...
            ua: 'Дістанься до місця влаштування на роботу вантажоперевізником',
        ...
        trucker2Deploy: {
            ...
            ua: 'Дістанься до місця влаштування на роботу далекобійником',
    ...
    talkWith: {
        mike: {
            ru: 'Поговори с Майком',
            ua: 'Поговори з Майком',
            en: 'Talk to Mike',
            de: 'Sprich mit Mike',
            pl: 'Porozmawiaj z Mikiem',
        },
        diana: {
    ...
    getToTalkWith: {
        mike: {
            ru: 'Вернись к Майку и поговори с ним',
            ua: 'Повернись до Майка і поговори з ним',
            en: 'Return to Mike and talk to him',
            de: 'Kehre zu Mike zurück und sprich mit ihm',
            pl: "Wróć do Mike'a i porozmawiaj z nim",
        },
        diana: {
            ru: 'Вернись к Диане, чтобы поговорить с ней',
            ua: 'Повернись до Діани, щоб поговорити з нею',
            en: 'Return to Diana to talk to her',
            de: 'Kehre zu Diana zurück, um mit ihr zu sprechen',
            pl: 'Wróć do Diany, aby z nią porozmawiać',
        },
        iori: {
            ru: 'Доберись до Иори, чтобы поговорить с ним',
            ua: 'Дістанься до Іорі, щоб поговорити з ним',
            en: 'Reach Iori to talk to him',
            de: 'Erreiche Iori, um mit ihm zu sprechen',
            pl: 'Dostań się do Ioriego, aby z nim porozmawiać',
        },
        slivnoyVitalya: {
            ru: 'Доберись до Сливного Витали, чтобы поговорить с ним',
            ua: 'Дістанься до Зливного Віталі, щоб поговорити з ним',
            en: 'Reach Broke Vitaly to talk to him',
            de: 'Erreiche Pleite-Vitali, um mit ihm zu sprechen',
            pl: 'Dostań się do Spłukanego Witalija, aby z nim porozmawiać',
        },
        oldJoe: {
            ru: 'Доберись до Старика Джо, чтобы поговорить с ним',
            ua: 'Дістанься до Старого Джо, щоб поговорити з ним',
        ...
        priest: {
            ru: 'Вернись к отцу, чтобы поговорить с ним',
            ua: 'Повернись до отця, щоб поговорити з ним',
            en: 'Return to the priest to talk to him',
            de: 'Kehre zum Priester zurück, um mit ihm zu sprechen',
            pl: 'Wróć do ojca, aby z nim porozmawiać',
        },
    },
    buyWeapon: {
        precisionrifle: {
            ru: 'Купи прецизионную винтовку в магазине оружия',
            ua: 'Купи прецизійну гвинтівку в магазині зброї',
            en: 'Buy the Precision Hunter at the gun store',
            de: 'Kauf dir den Präzisionsjäger im Waffengeschäft',
            pl: 'Kup Myśliwski Karabin Precyzyjny w sklepie z bronią',
        },
    },
    talkWithNpc: {
        ru: 'Поговори с {{name}}',
    ...
    getToNpcToTalk: {
        ru: 'Доберись до {{name}}, чтобы поговорить с ним',
        ua: 'Дістанься до {{name}}, щоб поговорити з ним',
    ...
    earnMoneyWorkingDumperInQuarry: {
        ru: 'Заработайте {{count}}$ работая водителем самосвала на шахте',
        ua: 'Заробіть {{count}}$, працюючи водієм самоскида на шахті',
        en: 'Earn {{count}}$ working as a dumper driver in the quarry',
        de: 'Verdiene {{count}}$, indem du als Muldenkipperfahrer im Steinbruch arbeitest',
        pl: 'Zarób {{count}}$ pracując jako kierowca wywrotki w kamieniołomie',
    },
    earnMoneyWorkingBulldozerInQuarry: {
        ru: 'Заработайте {{count}}$ работая водителем бульдозера на шахте',
        ua: 'Заробіть {{count}}$, працюючи водієм бульдозера на шахті',
        en: 'Earn {{count}}$ working as a bulldozer driver in the quarry',
        de: 'Verdiene {{count}}$, indem du als Bulldozerfahrer im Steinbruch arbeitest',
        pl: 'Zarób {{count}}$ pracując jako operator buldożera w kamieniołomie',
    },
    ...
    flappyBirdScoreInOneGame: {
        ru: 'Набери {{count}} очков за одну игру в Flappy Bird',
        ua: 'Набери {{count}} очок за одну гру у Flappy Bird',
        en: 'Score {{count}} points in a single Flappy Bird run',
        de: 'Erziele {{count}} Punkte in einem einzigen Flappy Bird Lauf',
        pl: 'Zdobądź {{count}} punktów w jednej grze Flappy Bird',
    },
    flappyBirdSumScore: {
        ru: 'Набери {{count}} очков в мини игре Flappy Bird',
        ua: 'Набери {{count}} очок у мінігрі Flappy Bird',
        en: 'Score {{count}} points in the Flappy Bird mini-game',
        de: 'Erziele {{count}} Punkte im Flappy Bird Minispiel',
        pl: 'Zdobądź {{count}} punktów w minigrze Flappy Bird',
    },
    grandmasterWinMatches: {
        ru: 'Победи в {{count}} партиях в шахматы',
        ua: 'Перемож у {{count}} партіях у шахи',
        en: 'Win {{count}} chess matches',
        de: 'Gewinne {{count}} Schachpartien',
        pl: 'Wygraj {{count}} partii szachów',
    },
    sendSmsPlayers: {
    ...
    buyPickaxe: {
        ru: 'Купи кирку в супермаркете',
        ua: 'Купи кирку в супермаркеті',
        en: 'Buy a pickaxe at the supermarket',
        de: 'Kauf eine Spitzhacke im Supermarkt',
        pl: 'Kup kilof w supermarkecie',
    },
    deployMiner: {
    ...
    buyWateringCanForJoe: {
        ru: 'Купи лейку в магазине 24/7',
        ua: 'Купи лійку в магазині 24/7',
        en: 'Buy a watering can at a 24/7 store',
        de: 'Kaufe eine Gießkanne im 24/7-Laden',
        pl: 'Kup konewkę w sklepie 24/7',
    },
    buyFarmSuppliesForJoe: {
        ru: 'Купи припасы для Старика Джо в магазине 24/7',
        ua: 'Купи припаси для Старого Джо в магазині 24/7',
        en: 'Buy supplies for Old Joe at a 24/7 store',
        de: 'Kaufe Vorräte für Old Joe im 24/7-Laden',
        pl: 'Kup zapasy dla Starego Joe w sklepie 24/7',
    },
    buyQuestItemShort: {
        ru: 'Купить: {{name}}',
        ua: 'Купити: {{name}}',
    ...
    buyPotatoSeedsForJoe: {
        ru: 'Купи 20 пачек семян картофеля в магазине 24/7',
        ua: 'Купи 20 пачок насіння картоплі в магазині 24/7',
        en: 'Buy 20 packs of potato seeds at a 24/7 store',
        de: 'Kaufe 20 Packungen Kartoffelsamen im 24/7-Laden',
        pl: 'Kup 20 paczek nasion ziemniaka w sklepie 24/7',
    },
    getToOldJoeField: {
        ru: 'Вернись к полю у Старика Джо',
        ua: 'Повернись до поля біля Старого Джо',
        en: 'Return to the field near Old Joe',
        de: 'Kehre zum Feld bei Old Joe zurück',
        pl: 'Wróć na pole obok Starego Joe',
    },
    plantPotatoesForJoe: {
        ru: 'Посади картошку {{count}} раз',
        ua: 'Посади картоплю {{count}} разів',
        en: 'Plant potatoes {{count}} times',
        de: 'Pflanze Kartoffeln {{count}} Mal',
        pl: 'Zasadź ziemniaki {{count}} razy',
    },
    collectPotatoesForJoe: {
        ru: 'Собери картошку {{count}} раз',
        ua: 'Збери картоплю {{count}} разів',
        en: 'Collect potatoes {{count}} times',
        de: 'Sammle Kartoffeln {{count}} Mal',
        pl: 'Zbierz ziemniaki {{count}} razy',
    },
    sellAllFarmLootForJoe: {
        ru: 'Продай скупщику {{buyerName}} всё, что собрал на ферме, за один раз',
        ua: 'Продай скупнику {{buyerName}} все, що зібрав на фермі, за один раз',
        en: 'Sell everything you collected on the farm to the fence {{buyerName}} in one go',
        de: 'Verkaufe dem Hehler {{buyerName}} alles, was du auf der Farm gesammelt hast, auf einmal',
        pl: 'Sprzedaj paserowi {{buyerName}} wszystko, co zebrałeś na farmie, za jednym razem',
    },
    plantAnySeedForJoe: {
        ru: 'Посади любое растение на ферме',
        ua: 'Посади будь-яку рослину на фермі',
        en: 'Plant any seed on the farm',
        de: 'Pflanze irgendeinen Samen auf der Farm',
        pl: 'Zasadź dowolne nasiono na farmie',
    },
    waterAnyPlantForJoe: {
        ru: 'Полей любое растение на ферме',
        ua: 'Полий будь-яку рослину на фермі',
        en: 'Water any plant on the farm',
        de: 'Gieße irgendeine Pflanze auf der Farm',
        pl: 'Podlej dowolną roślinę na farmie',
    },
    unloadAirCargoCrates: {
        ru: 'Выгрузите {{count}} ящиков, работая авиагрузчиком',
        ua: 'Вивантажте {{count}} ящиків, працюючи авіавантажником',
        en: 'Unload {{count}} crates while working as an air cargo loader',
        de: 'Entlade {{count}} Kisten, während du als Luftfracht-Lader arbeitest',
        pl: 'Rozładuj {{count}} skrzyń, pracując jako ładowacz lotniczy',
    },
    earnMoneyWorkingAirCargo: {
        ru: 'Заработайте ${{count}} работая авиагрузчиком',
        ua: 'Заробіть ${{count}}, працюючи авіавантажником',
        en: 'Earn ${{count}} working as an air cargo loader',
        de: 'Verdiene ${{count}}, indem du als Luftfracht-Lader arbeitest',
        pl: 'Zarób ${{count}}, pracując jako ładowacz lotniczy',
    },
    crackContrabandCrates: {
        ru: 'Вскройте {{count}} ящиков контрабанды',
        ua: 'Розкрийте {{count}} ящиків контрабанди',
        en: 'Crack {{count}} contraband crates',
        de: 'Knacke {{count}} Schmuggelkisten',
        pl: 'Otwórz {{count}} skrzyń z kontrabandą',
    },
    serviceCashCollectorAtms: {
        ru: 'Обслужите {{count}} банкоматов, работая инкассатором',
        ua: 'Обслужіть {{count}} банкоматів, працюючи інкасатором',
        en: 'Service {{count}} ATMs while working as a cash collector',
        de: 'Befülle {{count}} Geldautomaten, während du als Geldtransporter arbeitest',
        pl: 'Obsłuż {{count}} bankomatów, pracując jako konwojent',
    },
    completeBurglaryRuns: {
        ru: 'Успешно завершите {{count}} ограблений домов',
        ua: 'Успішно завершіть {{count}} пограбувань будинків',
        en: 'Successfully finish {{count}} house burglaries',
        de: 'Schließe {{count}} Hauseinbrüche erfolgreich ab',
        pl: 'Ukończ pomyślnie {{count}} włamań do domów',
    },
    completeTowTruckOrders: {
        ru: 'Выполните {{count}} заказов на эвакуаторе',
        ua: 'Виконайте {{count}} замовлень на евакуаторі',
        en: 'Complete {{count}} tow truck orders',
        de: 'Schließe {{count}} Abschleppaufträge ab',
        pl: 'Wykonaj {{count}} zleceń lawetą',
    },
    deliverStolenVehicles: {
        ru: 'Пригоните {{count}} угнанных машин заказчику',
        ua: 'Пригоніть {{count}} викрадених машин замовнику',
        en: 'Deliver {{count}} stolen cars to the buyer',
        de: 'Liefere {{count}} gestohlene Autos beim Auftraggeber ab',
        pl: 'Dostarcz {{count}} skradzionych aut zleceniodawcy',
    },
    washVehiclesCount: {
        ru: 'Помойте {{count}} машин на автомойке',
        ua: 'Помийте {{count}} машин на автомийці',
        en: 'Wash {{count}} vehicles at the car wash',
        de: 'Wasche {{count}} Fahrzeuge in der Waschanlage',
        pl: 'Umyj {{count}} pojazdów w myjni',
    },
    gymExercisesCount: {
        ru: 'Выполните {{count}} подходов в спортзале',
        ua: 'Виконайте {{count}} підходів у спортзалі',
        en: 'Finish {{count}} workout sets at the gym',
        de: 'Absolviere {{count}} Trainingssätze im Fitnessstudio',
        pl: 'Wykonaj {{count}} serii na siłowni',
    },
    shootingRangeRounds: {
        ru: 'Пройдите {{count}} упражнений в тире',
        ua: 'Пройдіть {{count}} вправ у тирі',
        en: 'Complete {{count}} rounds at the shooting range',
        de: 'Absolviere {{count}} Durchgänge auf dem Schießstand',
        pl: 'Zalicz {{count}} rund na strzelnicy',
    },
    refuelLiters: {
        ru: 'Залейте {{count}} литров топлива на АЗС',
        ua: 'Залийте {{count}} літрів пального на АЗС',
        en: 'Pump {{count}} litres of fuel at gas stations',
        de: 'Tanke {{count}} Liter Kraftstoff an Tankstellen',
        pl: 'Zatankuj {{count}} litrów paliwa na stacjach',
    },
    buyMealInCanteen: {
        ru: 'Пообедайте в столовой',
        ua: 'Пообідайте в їдальні',
        en: 'Have a meal at the canteen',
        de: 'Iss etwas in der Kantine',
        pl: 'Zjedz posiłek w stołówce',
    },
    petStreetAnimals: {
        ru: 'Погладьте {{count}} уличных животных',
        ua: 'Погладьте {{count}} вуличних тварин',
        en: 'Pet {{count}} street animals',
        de: 'Streichle {{count}} Straßentiere',
        pl: 'Pogłaszcz {{count}} zwierząt na ulicy',
    },
    winTennisMatch: {
        ru: 'Выиграйте партию в теннис',
        ua: 'Виграйте партію в теніс',
        en: 'Win a tennis match',
        de: 'Gewinne ein Tennismatch',
        pl: 'Wygraj mecz tenisa',
    },
    encounter: {
        pickUp: {
            ru: 'Подъедьте к {{name}} на машине со свободным местом',
            ua: 'Під\'їдьте до {{name}} на машині з вільним місцем',
            en: 'Pull up to {{name}} in a car with a free seat',
            de: 'Fahr mit einem freien Sitzplatz bei {{name}} vor',
            pl: 'Podjedź do {{name}} autem z wolnym miejscem',
        },
        ride: {
            ru: 'Отвезите {{name}} к метке',
            ua: 'Відвезіть {{name}} до мітки',
            en: 'Drive {{name}} to the waypoint',
            de: 'Fahr {{name}} zum Wegpunkt',
            pl: 'Zawieź {{name}} do punktu',
        },
        dropOff: {
            ru: 'Остановитесь, чтобы {{name}} вышел',
            ua: 'Зупиніться, щоб {{name}} вийшов',
            en: 'Stop the car so {{name}} can get out',
            de: 'Halt an, damit {{name}} aussteigen kann',
            pl: 'Zatrzymaj się, żeby {{name}} mógł wysiąść',
        },
    },
};
