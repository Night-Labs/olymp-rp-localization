export default {
    ...
    user: {
        ...
        blockConfirmText: {
            ...
            de: 'Bist du sicher, dass du {{user}} blockieren möchtest?',
        ...
        removeConfirmText: {
            ...
            de: 'Bist du sicher, dass du {{user}} aus deinen Kontakten entfernen möchten?',
        ...
        unblockConfirmText: {
            ...
            de: 'Bist du sicher, dass du {{user}} entsperren möchten?',
    ...
    notification: {
        contacts: {
            error: {
                ...
                de: 'Du hast ungültige Daten eingegeben, bitte versuche es erneut mit neuen Daten',
            ...
            exists: {
                ...
                de: 'Der Kontakt - {{firstName}} {{lastName}} mit der Nummer - {{number}} existiert bereits',
        ...
        blackList: {
            max: {
                ...
                de: 'Du hast das Limit für blockierte Nummern erreicht.',
