export default {
    ...
    moneyOperations: {
        add: {
            ...
            graffitiWarWin: {
                ru: 'За победу в войне за графити',
                ua: 'За перемогу у війні за графіті',
                en: 'For winning the graffiti war',
        ...
        take: {
            upgradePayday: {
                ru: 'Плата за улучшение {{upgrade}}. -${{money}}',
                ua: 'Плата за покращення {{upgrade}}. -${{money}}',
                en: 'Payment for upgrade {{upgrade}}. -${{money}}',
                de: 'Zahlung für das Upgrade {{upgrade}}. -${{money}}',
                pl: 'Opłata za ulepszenie {{upgrade}}. -${{money}}',
            },
            vehicleImpoundSalary: {
                ru: 'Выплата зарплаты эвакуаторщику {{name}}. -${{money}}',
                ua: 'Виплата зарплати евакуаторнику {{name}}. -${{money}}',
                en: 'Tow truck driver {{name}} salary payment. -${{money}}',
                de: 'Auszahlung des Abschleppfahrer-Gehalts an {{name}}. -${{money}}',
                pl: 'Wypłata pensji lawetnikowi {{name}}. -${{money}}',
            },
            boughtUpgrade: {
                ru: 'Покупка улучшения {{upgrade}} -${{money}}',
                ua: 'Купівля покращення {{upgrade}} -${{money}}',
                en: 'Bought upgrade {{upgrade}} -${{money}}',
            ...
            orderSupply: {
                ...
                en: 'Ordered supply delivery. -${{money}}',
