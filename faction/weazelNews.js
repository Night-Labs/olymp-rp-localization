export default {
    ...
    adDeclined: {
        ru: '!{#DA8815}[Weazel News] !{#FFFFFF}Ваше объявление отклонено сотрудником {{name}}.',
        ua: '!{#DA8815}[Weazel News] !{#FFFFFF}Ваше оголошення відхилено співробітником {{name}}.',
        en: '!{#DA8815}[Weazel News] !{#FFFFFF}Your ad was declined by staff member {{name}}.',
        de: '!{#DA8815}[Weazel News] !{#FFFFFF}Deine Anzeige wurde von Mitarbeiter {{name}} abgelehnt.',
        pl: '!{#DA8815}[Weazel News] !{#FFFFFF}Twoje ogłoszenie zostało odrzucone przez pracownika {{name}}.',
    },
    adDeclinedReason: {
        ru: '!{#A06A18}Причина: !{#FF5757}{{reason}}',
        ua: '!{#A06A18}Причина: !{#FF5757}{{reason}}',
        en: '!{#A06A18}Reason: !{#FF5757}{{reason}}',
        de: '!{#A06A18}Grund: !{#FF5757}{{reason}}',
        pl: '!{#A06A18}Powód: !{#FF5757}{{reason}}',
    },
    adDeclinedText: {
        ru: '!{#A06A18}Текст объявления: !{#e6e6e6}{{message}}',
        ua: '!{#A06A18}Текст оголошення: !{#e6e6e6}{{message}}',
        en: '!{#A06A18}Ad text: !{#e6e6e6}{{message}}',
        de: '!{#A06A18}Anzeigentext: !{#e6e6e6}{{message}}',
        pl: '!{#A06A18}Treść ogłoszenia: !{#e6e6e6}{{message}}',
    },
    newAdOnModeration: {
        ru: '!{#DA8815}[Weazel News] !{#FFFFFF}Новое объявление от {{name}} ожидает модерации.',
        ua: '!{#DA8815}[Weazel News] !{#FFFFFF}Нове оголошення від {{name}} очікує модерації.',
        en: '!{#DA8815}[Weazel News] !{#FFFFFF}A new ad from {{name}} is awaiting moderation.',
        de: '!{#DA8815}[Weazel News] !{#FFFFFF}Eine neue Anzeige von {{name}} wartet auf Moderation.',
        pl: '!{#DA8815}[Weazel News] !{#FFFFFF}Nowe ogłoszenie od {{name}} oczekuje na moderację.',
    },
