export default {
    ...
    tagline: {
        ru: 'Федеральная информационная сеть',
        ua: 'Федеральна інформаційна мережа',
        en: 'Federal Intelligence Network',
        de: 'Föderales Nachrichtennetzwerk',
        pl: 'Federalna sieć wywiadowcza',
    },
    authenticating: {
        ru: 'Идёт авторизация офицера',
        ua: 'Триває авторизація офіцера',
        en: 'Authenticating officer',
        de: 'Beamter wird authentifiziert',
        pl: 'Uwierzytelnianie funkcjonariusza',
    },
    authenticated: {
        ru: 'ДОПУЩЕНО',
        ua: 'ДОПУЩЕНО',
