...
export const cef = {
    ...
    transport: {
        ...
        orderTitle: {
            ru: 'Заказывание транспорта для фракции',
            en: 'Faction transport order',
            ua: 'Замовлення транспорту для фракції',
            de: 'Transportbestellung fur die Fraktion',
            pl: 'Zamowienie transportu dla frakcji',
            zh: '为帮派订购运输工具',
        },
        trunkCapacity: {
