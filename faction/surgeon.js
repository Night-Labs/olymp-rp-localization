export default {
    cef: {
        surgeon: {
            ru: 'Пластическая операция',
            ua: 'Пластична операція',
            en: 'Plastic surgery',
        ...
        pages: {
            parents: {
                ua: 'Генетичний профіль',
                en: 'Genetic Profile',
                ru: 'Генетический профиль',
                de: 'Genetisches Profil',
                pl: 'Profil genetyczny',
                zh: '遗传概况',
            },
            face: {
                ua: 'Хірургія обличчя',
