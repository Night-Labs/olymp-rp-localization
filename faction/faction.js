...
export const faction = {
    ...
    ems: {
        bedOccupied: {
            ...
            en: 'The bed is already occupied',
            de: 'Das Bett ist bereits belegt',
            pl: 'Łóżko jest już zajęte',
            zh: '床位已被占用',
        },
        bedHealed: {
        ...
        bedHealingStarted: {
            ...
            ua: 'Ви почали лікування',
            en: 'You started healing',
            de: 'Du hast die Behandlung begonnen',
            pl: 'Rozpocząłeś leczenie',
            zh: '你开始了治疗',
        },
        bedHealingStopped: {
            ru: 'Вы прекратили лечение',
            ua: 'Ви припинили лікування',
            en: 'You stopped healing',
            de: 'Du hast die Behandlung beendet',
