export default {
    ...
    addedNotSpawned: {
        ua: 'Транспорт додано до автопарку, але не вдалося його заспавнити',
        en: 'The vehicle was added to your garage but could not be spawned',
        ru: 'Транспорт добавлен в автопарк, но заспавнить его не удалось',
        de: 'Das Fahrzeug wurde deinem Fuhrpark hinzugefügt, konnte aber nicht gespawnt werden',
        pl: 'Pojazd został dodany do twojego parku, ale nie udało się go zespawnować',
        zh: '车辆已添加到车库，但无法生成',
    },
    rentExpired: {
