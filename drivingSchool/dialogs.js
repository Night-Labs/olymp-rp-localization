...
export default {
    ...
    messages: {
        ...
        startStudyFirstTime: {
            ...
            de: 'Super! Ich habe dem Ausbilder die Informationen über Sie und die Kategorie {{category}} weitergeleitet.\n\nDa Sie diese Kategorie zum ersten Mal absolvieren, erkläre ich Ihnen kurz, wie Ihre Ausbildung ablaufen wird. Zunächst absolvieren Sie einen Theoriekurs – versuchen Sie, sich alles gut einzuprägen, um die Prüfung nicht zu bestehen.\nIn der theoretischen Prüfung müssen Sie Fragen zu den im Kurs behandelten Themen beantworten. Bei Bestehen werden Sie zur praktischen Prüfung weitergeleitet.\nIn der praktischen Prüfung erhalten Sie ein Fahrzeug zur Absolvierung der Strecke, und unsere Ausbilderin wird darauf achten, dass Sie alle Anforderungen einhalten und keine Fehler machen.\nWenn Sie die praktische Prüfung bestehen, erhalten Sie die offizielle Erlaubnis, ein Fahrzeug dieser Kategorie für {{days}} Tage zu führen. Danach können Sie diese Berechtigung kostenlos durch Wiederholung des Tests oder gegen Zahlung von {{renewPrice}} verlängern.\n\nBeachten Sie – der Theorieteil ist völlig kostenlos, aber um den Test zu beginnen, müssen Sie {{price}} bezahlen. Wenn Sie den theoretischen oder praktischen Teil nicht bestehen, wird das Geld nicht zurückerstattet.\nUm mit der Ausbildung zu beginnen, gehen Sie bitte in den Klassenraum zu meiner Rechten – der Ausbilder wartet bereits auf Sie. Viel Erfolg!',
        ...
        startStudyRenew: {
            ...
            de: 'Super! Ich habe dem Ausbilder die Informationen über Sie und die Kategorie {{category}} weitergeleitet.\n\nIch bin sicher, Sie wissen bereits, was zu tun ist – trotzdem wünsche ich Ihnen viel Glück!',
