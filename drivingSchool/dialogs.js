...
export default {
    ...
    messages: {
        ...
        start: {
            ...
            de: 'Willkommen in der Fahrschule unseres Staates!\n\nHier kannst du eine theoretische und praktische Ausbildung für das Fahren aller Arten von Fahrzeugen absolvieren und anschließend einen offiziellen Führerschein der entsprechenden Kategorie erhalten.\n\nSchließlich ist das Fahren ohne Führerschein verboten... Wusstest du das nicht?',
        ...
        selectCategory: {
            ...
            de: 'Bitte wählen Sie die gewünschte Kategorie aus, damit ich Ihren Besitzstatus dieser Kategorie erfahren kann!',
        ...
        selectedCategoryHasLicense: {
            ...
            de: 'Ich habe deinen Status für die Kategorie {{category}} überprüft.\n\nDu hast Rechte für diese Kategorie, und diese sind bis zum {{expire}} gültig. Danach musst du diese erneuern. Du kannst dies bei uns absolut kostenlos tun, indem du den Test und die Praxis erneut absolvierst, oder es überspringen, indem du {{price}} bezahlst.',
        ...
        selectedCategoryExpiredLicense: {
            ...
            de: 'Ich habe deinen Status für die Kategorie {{category}} überprüft.\n\nDu hast Rechte für diese Kategorie, aber diese sind am 14.88.2077 abgelaufen. Du kannst diese absolut kostenlos erneuern, indem du den Test und die Praxis erneut absolvierst, oder dies überspringen, indem du {{price}}$ bezahlst.',
        ...
        startStudyFirstTime: {
            ...
            de: 'Super! Ich habe dem Ausbilder die Informationen über dich und die Kategorie {{category}} weitergeleitet.\n\nDa du diese Kategorie zum ersten Mal absolvierst, erkläre ich dir kurz, wie deine Ausbildung ablaufen wird. Zunächst absolvierst du einen Theoriekurs – versuche dir alles gut einzuprägen, um die Prüfung zu bestehen.\nIn der theoretischen Prüfung musst du Fragen zu den im Kurs behandelten Themen beantworten. Bei Bestehen wirst du zur praktischen Prüfung weitergeleitet.\nIn der praktischen Prüfung erhältst du ein Fahrzeug zur Absolvierung der Strecke, und unsere Ausbilderin wird darauf achten, dass du alle Anforderungen einhältst und keine Fehler machst.\nWenn du die praktische Prüfung bestehst, erhältst du die offizielle Erlaubnis, ein Fahrzeug dieser Kategorie für {{days}} Tage zu führen. Danach kannst du diese Berechtigung kostenlos durch Wiederholung des Tests oder gegen Zahlung von {{renewPrice}} verlängern.\n\nBeachte – der Theorieteil ist völlig kostenlos, aber um den Test zu beginnen, musst du {{price}} bezahlen. Wenn du den theoretischen oder praktischen Teil nicht bestehst, wird das Geld nicht zurückerstattet.\nUm mit der Ausbildung zu beginnen, gehe bitte in den Klassenraum zu meiner Rechten – der Ausbilder wartet bereits auf dich. Viel Erfolg!',
