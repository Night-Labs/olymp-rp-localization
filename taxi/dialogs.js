export default {
    ...
    wantJob1: {
        ...
        ua: 'Так, я хочу працювати в таксі!',
        en: 'Yes, I want to work in a taxi!',
        de: 'Ja, ich möchte als Taxifahrer arbeiten!',
        pl: 'Tak, chcę pracować w taksówce!',
    },
    message2: {
    ...
    wantJob2: {
        ru: 'Я уже всё понял, давай начнём работать.',
        ua: 'Я вже все зрозумів, давай почнемо працювати.',
        en: 'I’ve already understood everything, let’s start working.',
        de: 'Ich habe schon alles verstanden, lass uns anfangen zu arbeiten.',
        pl: 'Już wszystko zrozumiałem, zacznijmy pracę.',
    },
    message3: {
        ru: 'Ого, какое рвение. Ладно, на самом деле я тебе даже не особо нужен, чтобы начать работу. Всё, что требуется:\n1. Телефон.\n2. 5 уровень в штате.\n3. Действующие права категории B.\n4. Личный или арендованный автомобиль.',
        ua: 'Ого, який запал. Гаразд, насправді я тобі навіть не дуже потрібен, щоб почати роботу. Усе, що потрібно:\n1. Телефон.\n2. 5 рівень у штаті.\n3. Чинні права категорії B.\n4. Особистий або орендований автомобіль.',
        en: 'Wow, such enthusiasm. Well, actually you don’t really need me to start working. All you need is:\n1. A phone.\n2. Level 5 in the state.\n3. A valid Category B driver’s license.\n4. A personal or rented vehicle.',
        de: 'Wow, was für ein Eifer. Eigentlich brauchst du mich gar nicht wirklich, um mit der Arbeit zu beginnen. Alles, was du brauchst, ist:\n1. Ein Telefon.\n2. Level 5 im Staat.\n3. Einen gültigen Führerschein der Klasse B.\n4. Ein eigenes oder gemietetes Fahrzeug.',
        pl: 'Wow, jaki zapał. Właściwie to nie jestem ci nawet specjalnie potrzebny, żeby zacząć pracę. Wystarczy:\n1. Telefon.\n2. 5 poziom w stanie.\n3. Ważne prawo jazdy kategorii B.\n4. Własny lub wynajęty samochód.',
    },
    wantJob3: {
        ru: 'Всё так просто?',
        ua: 'Усе так просто?',
        en: 'Is it really that simple?',
        de: 'Ist das wirklich so einfach?',
        pl: 'Czy to naprawdę takie proste?',
    },

    message4: {
        ru: 'Да, всё очень просто. Но раз уж ты пришёл расскажу тебе больше подробностей',
        ua: 'Так, усе дуже просто. Але раз ти вже прийшов, розповім тобі більше подробиць',
        en: 'Yes, everything is very simple. But since you came, I’ll tell you more details',
        de: 'Ja, alles ist ganz einfach. Aber da du schon gekommen bist, erzähle ich dir mehr Details',
        pl: 'Tak, wszystko jest bardzo proste. Skoro już przyszedłeś, opowiem ci więcej szczegółów',
    },
    ...
    message5: {
        ru: 'Для начала тебе нужно запустить смену. Сядь в свою личную или арендованную машину, открой телефон и зайди в приложение такси.',
        ua: 'Для початку тобі потрібно розпочати зміну. Сядь у свою особисту або орендовану машину, відкрий телефон і зайди в застосунок таксі.',
        en: 'First, you need to start your shift. Get into your personal or rented car, open your phone and go to the taxi app.',
        de: 'Zuerst musst du deine Schicht starten. Setz dich in dein eigenes oder gemietetes Auto, öffne dein Handy und gehe in die Taxi-App.',
        pl: 'Na początek musisz rozpocząć zmianę. Wsiądź do swojego prywatnego lub wynajętego samochodu, otwórz telefon i wejdź do aplikacji taksówki.',
    },
    ...
    message6: {
        ru: 'В приложении выбери «Работать в такси». Там ты увидишь информацию о классах, работе и о том, как определилось твоё авто в системе.',
        ua: 'У застосунку вибери «Працювати в таксі». Там ти побачиш інформацію про класи, роботу та про те, як визначилося твоє авто в системі.',
        en: 'In the app, select “Work in taxi.” There you will see information about classes, work, and how your car is registered in the system.',
        de: 'Wähle in der App „Im Taxi arbeiten“. Dort siehst du Informationen über Klassen, die Arbeit und wie dein Auto im System eingestuft ist.',
        pl: 'W aplikacji wybierz „Pracuj w taksówce”. Tam zobaczysz informacje o klasach, pracy oraz o tym, jak twój samochód został określony w systemie.',
    },

    wantJob6: {
        ru: 'Можно уже начинать?',
        ua: 'Можна вже починати?',
        en: 'Can I start already?',
        de: 'Kann ich schon anfangen?',
        pl: 'Czy mogę już zaczynać?',
    },
    ...
    wantJob8: {
        ...
        en: 'Thanks, I’ll figure it out from here.',
        de: 'Danke, den Rest schaffe ich selbst.',
        pl: 'Dzięki, dalej poradzę sobie sam.',
    },

    rentCar: {
        ru: 'Я хочу арендовать машину.',
        ua: 'Я хочу орендувати машину.',
        en: 'I want to rent a car.',
        de: 'Ich möchte ein Auto mieten.',
        pl: 'Chcę wynająć samochód.',
    },
    leave: {
        ru: 'Я не хочу тут работать.',
        ua: 'Я не хочу тут працювати.',
        en: 'I don’t want to work here.',
        de: 'Ich möchte hier nicht arbeiten.',
