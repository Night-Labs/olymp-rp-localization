...
export const trucker2 = {
    ...
    gotJob: {
        ...
        de: 'Du hast den Job bekommen, hole den Anhänger ab.',
    ...
    leaveJob: {
        ...
        de: 'Du hast erfolgreich den Job verlassen',
    ...
    notifyAttachTrailer: {
        ...
        de: 'Du hast den Anhänger mit Ladung abgeholt, fahre zum Zielort.',
    ...
    notifyDetachTrailer: {
        ...
        de: 'Du hast einen Anhänger mit Ladung zurückgelassen. Bitte nehme ihn mit, bevor du deine Route fortsetzen.',
    ...
    notifyOverworked: {
        ...
        de: 'Entschuldigung, aber im Moment arbeiten zu viele Personen bei diesem Betrieb ({{count}}), bitte warte, bis jemand seine Arbeit beendet hat.',
    ...
    youCantEnterVehicle: {
        ...
        de: 'Dies ist nicht dein Arbeitsfahrzeug',
    ...
    youLeaveVehicle: {
        ...
        de: 'Du hast das Arbeitsfahrzeug verlassen, du hast 5 Minuten Zeit, um zurückzukehren, sonst wirst du gekündigt.',
    ...
    youHaveReturnedToVehicle: {
        ...
        de: 'Du bist zum Arbeitsfahrzeug zurückgekehrt',
    ...
    youBeenFired: {
        ...
        de: 'Du wurdest gekündigt, weil du dein Arbeitsfahrzeug längere Zeit unbeaufsichtigt gelassen haben',
    ...
    tasks: {
        goToTrailer: {
            ...
            de: 'Fahre zum Anhänger und hänge ihn an.',
        ...
        goToEndPoint: {
            ...
            de: 'Fahre zum Zielpunkt und parke den Anhänger.',
        ...
        safeDriving: {
            ...
            de: 'Liefere die Fracht unbeschädigt',
        ...
        detachLimit: {
            ...
            de: 'Trenne den Anhänger nicht ab',
        ...
        speedLimit: {
            ...
            de: 'Überschreite nicht die Geschwindigkeitsbegrenzung von {{km}} km/h',
        ...
        trafficRules: {
            ...
            de: 'Verstoße nicht gegen die Verkehrsregeln',
