export default {
    dialog1: {
        welcomeToRange: {
            ru: 'Добро пожаловать в тир! Здесь ты можешь научиться стрелять и даже получить лицензию на оружие. Что тебя интересует?',
            ua: 'Ласкаво просимо до стрілецького тиру! Тут ти можеш навчитися стріляти і навіть отримати ліцензію на зброю. Що тебе цікавить?',
        ...
        rangeInfo: {
            ru: 'Это место идеально подходит для начинающих и опытных стрелков. У нас есть разные виды оружия и тренеры, которые помогут тебе улучшить навыки.',
            ua: 'Це місце ідеально підходить для початківців і досвідчених стрільців. У нас є різні види зброї та тренери, які допоможуть тобі вдосконалити навички.',
        ...
        licenseQuery: {
            ru: 'Как насчет лицензии?',
            ua: 'Що з приводу ліцензії?',
        ...
        licenseProcedure: {
            ru: 'Чтобы получить лицензию, тебе нужно пройти обучение и настрелять определенное количество мишеней. Готов принять вызов?',
            ua: 'Щоб отримати ліцензію, тобі потрібно пройти навчання і вистрілити певну кількість мішеней. Готовий прийняти виклик?',
        ...
        needThink: {
            ru: 'Мне нужно подумать',
            ua: 'Мені потрібно подумати',
            en: 'I need to think',
        ...
        startShooting: {
            ru: 'Отлично! Вот твоя экипировка и оружие. Начнем?',
            ua: 'Чудово! Ось твоє спорядження і зброя. Починаємо?',
        ...
        askLicense: {
            ru: 'Спросить о лицензии',
            ua: 'Запитати про ліцензію',
        ...
        goodbyeMessage: {
            ru: 'Всегда рад видеть тебя здесь. Удачи!',
            ua: 'Завжди радий бачити тебе тут. Удачі!',
    ...
    dialog2: {
        returningShooterGreeting: {
            ru: 'Приветствую обратно! Хочешь попрактиковаться в стрельбе сегодня?',
            ua: 'Вітаю знову! Хочеш попрактикуватися у стрільбі сьогодні?',
        ...
        practiceShooting: {
            ru: 'Попрактиковаться в стрельбе',
            ua: 'Попрактикуватися у стрільбі',
        ...
        askNewWeapons: {
            ru: 'Спросить о новом оружии',
            ua: 'Запитати про нову зброю',
        ...
        shootingInstructions: {
            ru: 'Отлично! Вот твоё оборудование. Скажи, когда будешь готов начать.',
            ua: 'Чудово! Ось твоє обладнання. Скажи, коли будеш готовий почати.',
        ...
        newWeaponsInfo: {
            ru: 'У нас есть несколько новинок. Хочешь их испытать?',
            ua: 'У нас є кілька новинок. Хочеш їх випробувати?',
        ...
        tryNewWeapon: {
            ru: 'Попробовать новое оружие',
            ua: 'Спробувати нову зброю',
            en: 'Try new weapon',
        ...
        browseOrLeave: {
            ru: 'Можешь осмотреться или уйти, как захочешь.',
            ua: 'Можеш оглянутися або піти, як захочеш.',
    ...
    dialog3: {
        newVisitorGreeting: {
            ru: 'Привет! Ты впервые в нашем тире? Есть вопросы по лицензии или просто хочешь узнать больше о нас?',
            ua: 'Привіт! Ти вперше у нашому тирі? Маєш питання щодо ліцензії або просто хочеш дізнатися більше про нас?',
        ...
        inquireLicense: {
            ru: 'Расскажи про лицензию',
            ua: 'Розкажи про ліцензію',
        ...
        rangeInfoQuery: {
            ru: 'Что ты можешь рассказать о тире?',
            ua: 'Що ти можеш розповісти про тир?',
        ...
        justLooking: {
            ru: 'Я просто осматриваюсь',
            ua: 'Я просто оглядаюсь',
        ...
        licenseProcedureInfo: {
            ru: 'Чтобы получить лицензию на оружие, сначала нужно посетить полицейский участок, а затем прийти к нам для практической стрельбы.',
            ua: 'Щоб отримати ліцензію на зброю, спочатку потрібно відвідати поліцейський відділок, а потім прийти до нас для практичної стрільби.',
        ...
        policeStationQuery: {
            ru: 'Где находится полицейский участок?',
            ua: 'Де знаходиться поліцейський відділок?',
        ...
        rangeInfo: {
            ru: 'У нас есть разнообразные стрелковые дорожки и оружие для всех уровней подготовки. Ты можешь прийти и попрактиковаться в любое время.',
            ua: 'У нас є різноманітні стрілецькі доріжки та зброя для всіх рівнів підготовки. Ти можеш прийти та попрактикуватися в будь-який час.',
        ...
        licenseInterest: {
            ru: 'Хочу узнать про лицензию',
            ua: 'Хочу дізнатися про ліцензію',
        ...
        goodbyeMessage: {
            ru: 'Всегда рад видеть тебя! Приходи, когда захочешь.',
            ua: 'Завжди радий бачити тебе! Приходь, коли захочеш.',
        ...
        policeStationDirection: {
            ru: 'Полицейский участок находится на улице Миссия-Роу Синнер-стрит. Сначала туда, а потом обратно к нам.',
            ua: 'Поліцейський відділок знаходиться на вулиці Міссія-Роу Сіннер-стріт. Спочатку туди, а потім назад до нас.',
