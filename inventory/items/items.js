export const items = {
    ...
    medicalMaterials: {
        ...
        desc: {
            ...
            de: 'Werden zur Herstellung von Erste-Hilfe-Kästen und Medikamenten verwendet',
    ...
    bloodBag: {
        ...
        desc: {
            ...
            de: 'Bring ihn zum NPC im Labor, um eine Belohnung zu erhalten',
    ...
    boombox: {
        ...
        desc: {
            ...
            de: 'Eine laute, hochwertige Boombox, ideal für Partys mit Freunden',
    ...
    narrowCone: {
        ...
        desc: {
            ru: 'Узкий дорожный конус для ограждения территории.',
            ua: 'Вузький дорожній конус для огородження території.',
            en: 'A narrow traffic cone for cordoning off an area.',
            de: 'Ein schmaler Verkehrskegel zur Absperrung eines Bereichs.',
            pl: 'Wąski pachołek drogowy do wygradzania terenu.',
            zh: '用于封锁区域的窄型交通锥。',
        },
    },
    cone: {
        ...
        desc: {
            ru: 'Дорожный конус для ограждения территории.',
            ua: 'Дорожній конус для огородження території.',
            en: 'A traffic cone for cordoning off an area.',
            de: 'Ein Verkehrskegel zur Absperrung eines Bereichs.',
            pl: 'Pachołek drogowy do wygradzania terenu.',
            zh: '用于封锁区域的交通锥。',
        },
    },
    barrier: {
        ...
        desc: {
            ru: 'Дорожный барьер для блокировки проезда.',
            ua: 'Дорожній бар\'єр для блокування проїзду.',
            en: 'A road barrier for blocking traffic.',
            de: 'Eine Straßenabsperrung zur Verkehrsblockade.',
            pl: 'Bariera drogowa do blokowania ruchu.',
            zh: '用于封锁交通的路障。',
        },
    },
    barrier2: {
        ...
        desc: {
            ru: 'Усиленный дорожный барьер для блокировки проезда.',
            ua: 'Посилений дорожній бар\'єр для блокування проїзду.',
            en: 'A reinforced road barrier for blocking traffic.',
            de: 'Eine verstärkte Straßenabsperrung zur Verkehrsblockade.',
            pl: 'Wzmocniona bariera drogowa do blokowania ruchu.',
            zh: '用于封锁交通的加固路障。',
        },
    },
    barrier3: {
        ...
        desc: {
            ru: 'Лёгкий переносной барьер для ограждения территории.',
            ua: 'Легкий переносний бар\'єр для огородження території.',
            en: 'A lightweight portable barrier for cordoning off an area.',
            de: 'Eine leichte tragbare Absperrung zur Gebietsabsperrung.',
            pl: 'Lekka przenośna bariera do wygradzania terenu.',
            zh: '用于封锁区域的轻便路障。',
        },
    },
    spikeStrip: {
        ...
        desc: {
            ru: 'Полицейская полоса с шипами для прокола шин.',
            ua: 'Поліцейська смуга з шипами для проколу шин.',
            en: 'A police spike strip for puncturing tires.',
            de: 'Ein Polizei-Nagelstreifen zum Durchstechen von Reifen.',
            pl: 'Policyjna kolczatka do przebijania opon.',
            zh: '用于扎破轮胎的警用刺钉带。',
        },
    },
    rolling_paper: {
