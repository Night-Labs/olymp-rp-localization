export default {
    ...
    bird_feather: {
        ...
        desc: {
            ru: 'Целое маховое перо, ценится мастерами по мелочёвке',
            ua: 'Ціле махове пірʼя, цінується майстрами по дрібничках',
            en: 'An intact flight feather, valued by craftsmen for trinkets',
            de: 'Eine unversehrte Schwungfeder, bei Kunsthandwerkern begehrt',
            pl: 'Nienaruszone pióro lotne, cenione przez rzemieślników',
            zh: '完整的飞羽，手工艺人十分珍视',
        },
    },
    bird_raw_meat: {
        name: {
            ...
            ua: "Сире м'ясо птиці",
            en: 'Raw bird meat',
            de: 'Rohes Vogelfleisch',
            pl: 'Surowe mięso ptaka',
            zh: '生禽肉',
        },
        desc: {
            ru: 'Небольшая порция дичи, лучше прожарить',
            ua: 'Невелика порція дичини, краще просмажити',
            en: 'A small portion of game, better grilled first',
            de: 'Eine kleine Portion Wildfleisch, besser gegrillt',
            pl: 'Mała porcja dziczyzny, lepiej ją usmażyć',
            zh: '一小份野味，最好先烤熟',
        },
    },
    bird_grilled_meat: {
        name: {
            ru: 'Жареное мясо птицы',
            ua: "Смажене м'ясо птиці",
            en: 'Grilled bird meat',
            de: 'Gegrilltes Vogelfleisch',
            pl: 'Smażone mięso ptaka',
            zh: '烤禽肉',
        },
        desc: {
            ru: 'Прожаренная дичь, безопасная для еды',
            ua: 'Просмажена дичина, безпечна для їжі',
            en: 'Cooked game, safe to eat',
            de: 'Durchgegartes Wildfleisch, sicher zu essen',
            pl: 'Wysmażona dziczyzna, bezpieczna do zjedzenia',
            zh: '烤熟的野味，可以安全食用',
        },
    },
    hawk_talon: {
        ...
        desc: {
            ru: 'Редкий трофей: сбить ястреба в воздухе удаётся немногим',
            ua: 'Рідкісний трофей: збити яструба в повітрі вдається небагатьом',
            en: 'A rare trophy: few manage to bring a hawk down in flight',
            de: 'Eine seltene Trophäe: Nur wenige holen einen Habicht im Flug herunter',
            pl: 'Rzadkie trofeum: mało kto zestrzeli jastrzębia w locie',
            zh: '稀有战利品：能在空中击落鹰的人寥寥无几',
        },
    },
};
