...
export const server = {
    ...
    welcomeAdminMessage: {
        ...
        de: '~r~Du bist ein Administrator der Stufe {{lvl}}. Um den Administratormodus aufzurufen, gebe /admin ein',
    ...
    enteredToAdmin: {
        ...
        de: '~r~Du hast den Administratormodus aufgerufen. Um den Modus zu verlassen, gebe /admin ein',
    ...
    youReachedMaxWarns: {
        ...
        de: 'Du hast die maximale Anzahl an Warnungen erreicht und wurden gesperrt',
    ...
    object: {
        ...
        failedSpawn: {
            ...
            de: 'Objekt {{model}} konnte nicht erstellt werden',
        ...
        failedStartPlacement: {
            ...
            de: 'Die Platzierung für Objekt {{model}} konnte nicht gestartet werden',
        ...
        tooManySimilarObjectsNearby: {
            ...
            de: 'In der Nähe gibt es bereits zu viele {{model}}-Objekte: maximal {{limit}} im Radius von {{radius}} m',
        ...
        useCameraGizmoThenFinish: {
            ...
            de: 'Benutze die Kamera und das Gizmo, dann /spawn_object_done',
        ...
        failedFinishPlacement: {
            ...
            de: 'Die Objektplatzierung konnte nicht abgeschlossen werden',
