export const cef = {
    ...
    banned: {
        ...
        subtitle: {
            ...
            de: 'Du kannst dich bis zum Ende der Sperre nicht in deinen Account einloggen',
        ...
        hint1: {
            ...
            de: 'Wenn du denkst, dass die Sperre ein Fehler ist, wende dich an',
            pl: 'Jeśli uważasz, że blokada to błąd — skontaktuj się z',
        },
        hint2: {
            ru: 'дискорд сервера',
            ua: 'дискорд сервера',
            en: 'the Discord server',
            de: 'des Discord-Servers',
            pl: 'serwera Discord',
        },
        notify: {
            header: {
            ...
            text: {
                ru: 'Ссылка на дискорд сервер скопирована, вставь её в браузер',
                ua: 'Посилання на сервер Discord скопійовано, встав його в браузер',
