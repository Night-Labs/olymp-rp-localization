export const beards = {
    ...
    chinPencilMustache: {
        ua: 'Підборідочний усик-карандаш',
        en: 'Chin Pencil Mustache',
        ru: 'Подбородочный усик-карандаш',
        de: 'Dünner Kinnschnurrbart',
    ...
    scruffy: {
        ...
        en: 'Scruffy',
        ru: 'Неопрятный',
        de: 'Breiter Schnauzbart mit Kinnzipfel',
        pl: 'Niedbały',
       zh:'邋遢',
    },
    
    musketeerBeard: {
        ua: 'Мушкетерська борода',
        en: 'Musketeer Beard',
    ...
    thinCircleBeard: {
        ...
        en: 'Thin Circle Beard',
        ru: 'Тонкая круглая борода',
        de: 'Feiner Stoppelbart',
    ...
    handlebarMustache: {
        ...
        ru: 'Конские усы',
        de: 'Dichter Stoppelbart',
        pl: 'Wąsy w stylu kierownicy',
       zh:'手把胡',
    },
    
    chinPencilMustacheAndSideburns: {
        ua: 'Підборідочний усик-карандаш і бакенбарди',
        en: 'Chin Pencil Mustache and Sideburns',
        ru: 'Подбородочный усик-карандаш и бакенбарды',
        de: 'Schnurrbart mit Koteletten-Rahmen',
        pl: 'Wąsy podbródkowe i baki',
       zh:'下巴铅笔胡须和鬓角',
    },
    
    goateeOnChin: {
        ua: 'Козлина на підборідді',
        en: 'Goatee on Chin',
        ru: 'Бородка на подбородке',
        de: 'Ziegenbart mit hinteren Mustern',
        pl: 'Koźlina na podbródku',
        zh:'中国山羊胡',
    },
    
    balboAndSideburns: {
        ua: 'Бальбо і бакенбарди',
        en: 'Balbo and Sideburns',
        ru: 'Бальбо и бакенбарды',
        de: 'Balbo-Bart mit Koteletten',
        pl: 'Balbo i baki',
        zh:'Balbo和鬓角',
    },
    
    muttonChops: {
        ua: 'Вівцячі бакенбарди',
        en: 'Mutton Chops',
    ...
    curlyBeard: {
        ...
        en: 'Curly Beard',
        ru: 'Кудрявая борода',
        de: 'Aufgedrehter Schnurrbart und Kinnbart',
        pl: 'Kręcony zarost',
        zh:'虬髯',
    },
    
    curlyAndThickBeard: {
        ua: 'Кучерява і густа борода',
        en: 'Curly and Thick Beard',
        ru: 'Кудрявая и густая борода',
        de: 'Dichter, gekräuselter Schnurrbart',
    ...
    ottoAndThickBeard: {
        ua: 'Отто і густа борода',
        en: 'Otto and Thick Beard',
