export const player = {
    ...
    pairsAnimations: {
        ...
        fistBump: {
            ru: 'Стукнуться кулаками',
            ua: 'Стукнутися кулаками',
            en: 'Fist Bump',
            de: 'Faustgruß',
            pl: 'Żółwik',
            zh: '碰拳',
        ...
        backslap: {
            ru: 'Похлопать по спине',
            ua: 'Поплескати по спині',
            en: 'Backslap',
            de: 'Auf den Rücken klopfen',
            pl: 'Poklepać po plecach',
            zh: '拍背',
        },
        manlyHandshake: {
            ru: 'Крепкое рукопожатие',
            ua: 'Міцне рукостискання',
            en: 'Manly Handshake',
            de: 'Kräftiger Handschlag',
            pl: 'Męski uścisk dłoni',
            zh: '男子汉握手',
        },
        daps: {
            ru: 'Уличное приветствие',
            ua: 'Вуличне привітання',
            en: 'Daps',
            de: 'Straßengruß',
            pl: 'Uliczne powitanie',
            zh: '街头问候',
        },
        laugh: {
            ru: 'Посмеяться вместе',
            ua: 'Посміятися разом',
            en: 'Laugh Together',
            de: 'Zusammen lachen',
            pl: 'Pośmiać się razem',
            zh: '一起大笑',
        },
    },
