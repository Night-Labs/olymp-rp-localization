    ...
    stashDealer: {
        main: {
            whatAreYouAfter: {
                ...
                pl: 'No? Partia na zamowienie, czy przyszedles rozlozyc swoje?',
            },
            contractBatch: {
                ...
                pl: 'Partia na zamowienie rodziny',
            },
            runSideJob: {
            ...
            contractBriefing: {
                ...
                de: 'Meine Ware, deine Haende. {{drops}} Punkte auf der Karte, hinfahren, ablegen, weiter. Bargeld gibt es von mir nicht - die Charge wird deinen Leuten bezahlt.',
                pl: 'Towar moj, rece twoje. {{drops}} punktow na mapie, podjezdzasz, zostawiasz, jedziesz dalej. Gotowki ode mnie nie bedzie - za partie place twoim.',
            },
            giveMeTheBatch: {
                ru: 'Давай партию',
                ua: 'Давай партію',
            ...
            sideJobBriefing: {
                ...
                pl: '{{drug}} - towar jest twoj, ja daje tylko adresy. Potrzebujesz {{need}} x "{{item}}" przy sobie, masz {{have}}. Place ${{pay}} za kazda podrzucona.',
            },
            letsRun: {
                ru: 'Давай адреса',
                ua: 'Давай адреси',
        ...
        idle: {
            noOrderNoBatch: {
                ...
                pl: 'Nie znam cie. Niech twoi wezma zlecenie albo otworza sobie linie - wtedy pogadamy.',
            },
            gotIt: {
                ru: 'Понял',
                ua: 'Зрозумів',
        ...
        busy: {
            finishWhatYouHave: {
                ...
                de: 'Deine Haende sind schon voll. Mach fertig und komm wieder.',
                pl: 'Masz juz zajete rece. Skoncz i wracaj.',
            },
            gotIt: {
                ru: 'Понял',
                ua: 'Зрозумів',
