...
export const tree = {
    ...
    info: {
        ...
        requirementMoney: {
            ru: ' - Баланс организации: ${{current}}/${{required}}',
            ua: ' - Баланс організації: ${{current}}/${{required}}',
            en: ' - Organization balance: ${{current}}/${{required}}',
            de: ' - Organisationsguthaben: ${{current}}/${{required}}',
            pl: ' - Bilans organizacji: ${{current}}/${{required}}',
        },
        prerequisites: {
    ...
    errors: {
        ...
        buildSlotBusy: {
            ru: 'В организации уже строится другое улучшение. Одновременно можно строить только одно.',
            ua: 'В організації вже будується інше покращення. Одночасно можна будувати лише одне.',
            en: 'Another upgrade is already building. An organization builds one at a time.',
            de: 'Ein anderes Upgrade ist bereits im Bau. Eine Organisation baut nur eines zur Zeit.',
            pl: 'Inne ulepszenie juz sie buduje. Organizacja buduje tylko jedno naraz.',
        },
        alreadyUnlocked: {
        ...
        insufficientFunds: {
            ru: 'Недостаточно средств на балансе организации: ${{current}}/${{required}}.',
            ua: 'Недостатньо коштів на балансі організації: ${{current}}/${{required}}.',
            en: 'Insufficient organization balance: ${{current}}/${{required}}.',
    ...
    panel: {
        ...
        money: { ru: 'Баланс организации', ua: 'Баланс організації', en: 'Organization balance', de: 'Organisationsguthaben', pl: 'Bilans organizacji' },
        ...
        buildSlotBusyHint: {
            ru: 'Одновременно строится одно улучшение',
            ua: 'Одночасно будується одне покращення',
            en: 'One upgrade builds at a time',
            de: 'Es baut immer nur ein Upgrade',
            pl: 'Naraz buduje sie jedno ulepszenie',
        },
        buildingNow: { ru: 'Сейчас строится', ua: 'Зараз будується', en: 'Building now', de: 'Im Bau', pl: 'Teraz sie buduje' },
        buildSlotBusy: { ru: 'Строится другое улучшение', ua: 'Будується інше покращення', en: 'Another upgrade is building', de: 'Anderes Upgrade im Bau', pl: 'Buduje sie inne ulepszenie' },
    },
    duration: {
    ...
    durationLong: {
        minutes: {
            one: { ru: '{{value}} минута', ua: '{{value}} хвилина', en: '{{value}} minute', de: '{{value}} Minute', pl: '{{value}} minuta' },
            few: { ru: '{{value}} минуты', ua: '{{value}} хвилини', en: '{{value}} minutes', de: '{{value}} Minuten', pl: '{{value}} minuty' },
            many: { ru: '{{value}} минут', ua: '{{value}} хвилин', en: '{{value}} minutes', de: '{{value}} Minuten', pl: '{{value}} minut' },
        },
        hours: {
            one: { ru: '{{value}} час', ua: '{{value}} година', en: '{{value}} hour', de: '{{value}} Stunde', pl: '{{value}} godzina' },
            few: { ru: '{{value}} часа', ua: '{{value}} години', en: '{{value}} hours', de: '{{value}} Stunden', pl: '{{value}} godziny' },
            many: { ru: '{{value}} часов', ua: '{{value}} годин', en: '{{value}} hours', de: '{{value}} Stunden', pl: '{{value}} godzin' },
        },
        days: {
            one: { ru: '{{value}} день', ua: '{{value}} день', en: '{{value}} day', de: '{{value}} Tag', pl: '{{value}} dzień' },
            few: { ru: '{{value}} дня', ua: '{{value}} дні', en: '{{value}} days', de: '{{value}} Tage', pl: '{{value}} dni' },
            many: { ru: '{{value}} дней', ua: '{{value}} днів', en: '{{value}} days', de: '{{value}} Tage', pl: '{{value}} dni' },
        },
    },
    nodes,
};
