export const progression = {
    notify: {
        header: {
            ru: 'Прогресс организации',
            ua: 'Прогрес організації',
            en: 'Organization Progress',
            de: 'Organisationsfortschritt',
            pl: 'Postęp organizacji',
        },
    },
    success: {
        levelUp: {
            ru: 'Организация {{orgName}} достигла уровня {{level}} (был {{previousLevel}})',
            ua: 'Організація {{orgName}} досягла рівня {{level}} (був {{previousLevel}})',
            en: 'Organization {{orgName}} reached level {{level}} (was {{previousLevel}})',
