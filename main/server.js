export const server = {
    ...
    serverRestartAnnouncementChat: {
        ru: 'ВНИМАНИЕ! Уважаемые игроки, через {{minutes}} минут будет рестарт сервера!',
        ua: 'УВАГА! Шановні гравці, через {{minutes}} хвилин буде рестарт сервера!',
        en: 'WARNING! Dear players, the server will restart in {{minutes}} minutes!',
        de: 'ACHTUNG! Liebe Spieler, der Server wird in {{minutes}} Minuten neu gestartet!',
        pl: 'UWAGA! Drodzy gracze, za {{minutes}} minut nastąpi restart serwera!',
        zh: '警告！各位玩家，服务器将在 {{minutes}} 分钟后重启！',
    },
    ...
    serverRestartCanceledChat: {
        ru: 'ВНИМАНИЕ! Уважаемые игроки, рестарт сервера отменен!',
        ua: 'УВАГА! Шановні гравці, рестарт сервера скасовано!',
        en: 'WARNING! Dear players, the server restart has been canceled!',
        de: 'ACHTUNG! Liebe Spieler, der Serverneustart wurde abgesagt!',
        pl: 'UWAGA! Drodzy gracze, restart serwera został anulowany!',
        zh: '警告！各位玩家，服务器重启已取消！',
    },
