export default {
    messageSalary: {
        ru: '~o~[PAYDAY] ~w~Вы получили зарплату в размере {{money}}',
        ua: '~o~[PAYDAY] ~w~Ви отримали зарплату в розмірі {{money}}',
        en: '~o~[PAYDAY] ~w~You received a salary of {{money}}',
        de: '~o~[PAYDAY] ~w~Du hast ein Gehalt von {{money}} erhalten',
    ...
    messageBenefits: {
        ...
        ua: '~o~[PAYDAY] ~w~Ви отримали допомогу по безробіттю: {{benefits}}',
        en: '~o~[PAYDAY] ~w~You received unemployment benefits: {{benefits}}',
        de: '~o~[PAYDAY] ~w~Du hast Arbeitslosengeld erhalten: {{benefits}}',
