export default {
    ...
    youHaveCaughtCold: {
        ...
        de: '~b~Es sieht so aus, als hätten Sie sich erkältet. Nehmen Sie Medikamente oder gehen Sie ins Krankenhaus, bevor sich Ihr Zustand verschlechtert',
    ...
    youAreCuredCold: {
        ...
        de: '~b~Sie haben sich vollständig von der Erkältung erholt. Kein Husten, keine Schwäche und keine laufende Nase mehr. Atmen Sie auf – aber achten Sie weiterhin auf Ihre Gesundheit!',
    ...
    youHaveMildColdSymptoms: {
        ...
        de: '~b~Sie haben derzeit leichte Erkältungssymptome',
    ...
    coldIsProgressingConsiderTreatment: {
        ...
        de: '~b~Die Erkältung schreitet voran, Sie werden häufiger husten und Gesundheit verlieren – denken Sie über eine Behandlung nach',
