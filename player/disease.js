export default {
    ...
    youHaveMildColdSymptoms: {
        ...
        ua: '~b~У вас поки що легкі симптоми застуди',
        en: '~b~You currently have mild cold symptoms',
        de: '~b~Du hast derzeit leichte Erkältungssymptome',
        pl: '~b~Masz obecnie łagodne objawy przeziębienia',
    },
    ...
    youHaveFoodPoisoning: {
        ...
        de: '~r~Du hast eine Lebensmittelvergiftung! Suche sofort einen Arzt auf oder nehme Aktivkohle, sonst könnte dein Zustand kritisch werden',
    ...
    youAreCuredFoodPoisoning: {
        ...
        de: '~b~Du hast dich vollständig von der Lebensmittelvergiftung erholt. Übelkeit, Erbrechen und Bauchschmerzen gehören der Vergangenheit an. Achte in Zukunft mehr darauf was du Isst!',
    ...
    mildFoodPoisoningSymptoms: {
        ...
        de: '~y~Du hast leichte Symptome einer Lebensmittelvergiftung - leichte Übelkeit und Magenbeschwerden',
    ...
    severeFoodPoisoning: {
        ...
        de: '~r~Du hast eine schwere Lebensmittelvergiftung! Ständiges Erbrechen, Durchfall und starke Schmerzen erschöpfen deinen Körper',
    ...
    criticalFoodPoisoning: {
        ...
        de: '~r~KRITISCHER ZUSTAND! Dehydration und Vergiftung haben ein gefährliches Niveau erreicht. Ohne medizinische Hilfe könntest du sterben!',
    ...
    lifeThreatening: {
        ...
        de: '~r~LEBENSGEFAHR! Dein Körper steht kurz vor dem kompletten Versagen durch schwere Vergiftung. Jede Minute zählt!',
    ...
    diedFromFoodPoisoning: {
        ...
        de: '~r~Du bist an einer schweren Lebensmittelvergiftung gestorben. Dehydration und Vergiftung erwiesen sich als tödlich...',
    ...
    diarrheaSymptom: {
        ...
        de: '~y~Durchfall verstärkt die Dehydration und schwächt dich',
