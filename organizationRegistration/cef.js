export const cef = {
    ...
    step2: {
        ...
        logoErrors: {
            ...
            invalidResolution: {
                ru: 'Размер логотипа должен быть от 64x64 до 1024x1024 пикселей. Уменьшите картинку и выберите её снова.',
                ua: 'Розмір логотипа має бути від 64x64 до 1024x1024 пікселів. Зменште картинку й оберіть її знову.',
                en: 'The logo must be between 64x64 and 1024x1024 pixels. Resize the image and pick it again.',
                de: 'Das Logo muss zwischen 64x64 und 1024x1024 Pixel groß sein. Verkleinern Sie das Bild und wählen Sie es erneut.',
                pl: 'Logo musi mieć od 64x64 do 1024x1024 pikseli. Zmniejsz obraz i wybierz go ponownie.',
            },
            uploadExpired: {
                ru: 'Загруженный логотип устарел. Нажмите "Создать организацию" ещё раз.',
                ua: 'Завантажений логотип застарів. Натисніть "Створити організацію" ще раз.',
                en: 'The uploaded logo has expired. Press "Create Organization" again.',
                de: 'Das hochgeladene Logo ist abgelaufen. Drücken Sie erneut auf "Organisation erstellen".',
                pl: 'Przesłane logo wygasło. Naciśnij ponownie "Utwórz organizację".',
            },
            animatedNotAllowed: {
        ...
        submitErrors: {
            ...
            inProgress: {
                ru: 'Организация уже создаётся. Дождитесь результата.',
                ua: 'Організація вже створюється. Дочекайтеся результату.',
                en: 'The organization is already being created. Wait for the result.',
                de: 'Die Organisation wird bereits erstellt. Warten Sie auf das Ergebnis.',
                pl: 'Organizacja jest już tworzona. Poczekaj na wynik.',
            },
            noAnswer: {
                ru: 'Сервер не ответил вовремя. Если организация создалась, придёт уведомление. Не нажимайте повторно.',
                ua: 'Сервер не відповів вчасно. Якщо організацію створено, прийде сповіщення. Не натискайте повторно.',
                en: 'The server did not answer in time. If the organization was created, you will get a notification. Do not press again.',
                de: 'Der Server hat nicht rechtzeitig geantwortet. Wenn die Organisation erstellt wurde, kommt eine Benachrichtigung. Nicht erneut drücken.',
                pl: 'Serwer nie odpowiedział na czas. Jeśli organizacja powstała, dostaniesz powiadomienie. Nie naciskaj ponownie.',
            },
            invalidPayload: {
                ru: 'Данные формы повреждены. Закройте регистрацию и откройте её заново.',
                ua: 'Дані форми пошкоджено. Закрийте реєстрацію та відкрийте її знову.',
                en: 'The form data is invalid. Close the registration and open it again.',
                de: 'Die Formulardaten sind ungültig. Schließen Sie die Registrierung und öffnen Sie sie erneut.',
                pl: 'Dane formularza są nieprawidłowe. Zamknij rejestrację i otwórz ją ponownie.',
            },
            insufficientCash: {
                ru: 'Недостаточно наличных: нужно ${{amount}} при себе. Деньги на банковском счёте не учитываются.',
                ua: 'Недостатньо готівки: потрібно ${{amount}} при собі. Гроші на банківському рахунку не враховуються.',
                en: 'Not enough cash: you need ${{amount}} on hand. Money in your bank account does not count.',
                de: 'Nicht genug Bargeld: Sie brauchen ${{amount}} bei sich. Geld auf dem Bankkonto zählt nicht.',
                pl: 'Za mało gotówki: potrzebujesz ${{amount}} przy sobie. Pieniądze na koncie bankowym się nie liczą.',
            },
            insufficientCoins: {
                ru: 'Недостаточно Olymp-Coin: нужно {{amount}}.',
                ua: 'Недостатньо Olymp-Coin: потрібно {{amount}}.',
                en: 'Not enough Olymp Coins: you need {{amount}}.',
                de: 'Nicht genug Olymp-Coins: Sie brauchen {{amount}}.',
                pl: 'Za mało Olymp-Coin: potrzebujesz {{amount}}.',
            },
            propertyUnavailable: {
                ru: 'Выбранная недвижимость больше не подходит для штаба. Откройте регистрацию заново и выберите другую.',
                ua: 'Обрана нерухомість більше не підходить для штабу. Відкрийте реєстрацію знову та оберіть іншу.',
                en: 'The selected property can no longer be the headquarters. Open the registration again and pick another one.',
                de: 'Die gewählte Immobilie kann nicht mehr das Hauptquartier sein. Öffnen Sie die Registrierung erneut und wählen Sie eine andere.',
                pl: 'Wybrana nieruchomość nie może już być siedzibą. Otwórz rejestrację ponownie i wybierz inną.',
            },
            logoServiceUnavailable: {
                ru: 'Сервис обработки логотипов сейчас недоступен. Деньги не списаны, попробуйте позже.',
                ua: 'Сервіс обробки логотипів зараз недоступний. Гроші не списано, спробуйте пізніше.',
                en: 'The logo service is unavailable right now. You were not charged, try again later.',
                de: 'Der Logo-Dienst ist gerade nicht verfügbar. Es wurde nichts abgebucht, versuchen Sie es später erneut.',
                pl: 'Usługa logo jest teraz niedostępna. Nie pobrano opłaty, spróbuj później.',
            },
            uploadUnavailable: {
                ru: 'Не удалось загрузить логотип: сервер загрузки не отвечает. Деньги не списаны, попробуйте позже.',
                ua: 'Не вдалося завантажити логотип: сервер завантаження не відповідає. Гроші не списано, спробуйте пізніше.',
                en: 'Failed to upload the logo: the upload server is not responding. You were not charged, try again later.',
                de: 'Das Logo konnte nicht hochgeladen werden: Der Upload-Server antwortet nicht. Es wurde nichts abgebucht, versuchen Sie es später erneut.',
                pl: 'Nie udało się przesłać logo: serwer przesyłania nie odpowiada. Nie pobrano opłaty, spróbuj później.',
            },
            generic: {
