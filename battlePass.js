export default {
        ...
        quests: {
            ...
            earn: {
                trucker: {
                    ...
                    description: {
                        ru: 'Заработайте {{target}}$ на работе грузоперевозчика.',
                        ua: 'Заробіть {{target}}$ на роботі вантажоперевізника.',
                        en: 'Earn {{target}}$ working as a carrier.',
                        de: 'Verdiene {{target}}$ als Lkw-Fahrer.',
    ...
    notify: {
        ...
        tierMinLevel: {
            ru: 'Battle Pass можно начать только с {{level}} уровня персонажа',
            ua: 'Battle Pass можна почати лише з {{level}} рівня персонажа',
            en: 'Battle Pass can only be started at character level {{level}}',
            de: 'Battle Pass kann erst ab Charakterstufe {{level}} gestartet werden',
            pl: 'Karnet bojowy można rozpocząć dopiero na {{level}} poziomie postaci',
        },
        freeXpClaimed: {
